...
class TestJsonNLPManipulation(TestCase):
    def test_remove_empty_fields(self):
        ...
        d['documents'] = [
            OrderedDict([('a', 1), ('b', ''), ('c', []), ('d', [1, 2])]),
            OrderedDict([('a', 1), ('b', ''), ('c', {}), ('d', [1, 2])])
        ]
        actual = pyjsonnlp.remove_empty_fields(d)
        expected = OrderedDict([('a', 1), ('d', [1, 2]), ('meta', OrderedDict([('a', 1), ('d', [1, 2])])), ('documents', [OrderedDict([('a', 1), ('d', [1, 2])]), OrderedDict([('a', 1), ('d', [1, 2])])])])
        assert expected == actual, actual
